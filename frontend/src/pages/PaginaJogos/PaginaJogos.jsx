...
import JogosFiltrosCard from "./components/JogosFiltrosCard";
import rawgService from "../../services/rawgService";
import { useToast } from "../../context/ToastContext";
import useDebounce from "../../utils/useDebounce";

const buscarJogosPaginados = (params) => JogoService.buscarJogosPaginados(params);
const obterMetadadosFiltros = () => JogoService.obterMetadadosFiltros();
import { 
  FaGamepad, 
  FaSearch, 
  FaCalendarAlt, 
    ...
    return (
        <div className="pagina-jogos-container">
            ...
            <div className="pagina-jogos-content">
                ...
                {/* Caixa de Filtros e Busca Modularizada */}
                <JogosFiltrosCard
                    ...
                    handleToggleGenero={handleToggleGenero}
                    handleRemoverGenero={handleRemoverGenero}
                    handleLimparGeneros={() => {
                        setGenerosSelecionados([]);
                        setPaginaAtual(1);
                        atualizarUrl(1, termoPesquisa, [], anoSelecionado, notaSelecionada, ordenacao);
                    }}
                    anoInput={anoInput}
                    handleAnoChange={handleAnoChange}
                    handleLimparAno={handleLimparAno}
                    notaSelecionada={notaSelecionada}
                    handleNotaChange={handleNotaChange}
                    ordenacao={ordenacao}
                    handleOrdenacaoChange={handleOrdenacaoChange}
